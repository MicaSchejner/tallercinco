...
public class MainActivity_ocio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<String> desc = (ArrayList<String>) b.getOcio(Integer.parseInt(idCiudad));
        ...
        int resID = getResources().getIdentifier("ocio" +idCiudad.toString()  , "drawable", getPackageName());
